...
void CDXInput::_WriteError(const char *error)
{
	::MessageBox(0, error, "´íÎó", 0);
}
...
bool CDXInput::Init(HWND hWnd, HINSTANCE hInstance)
{
	...
	{
		_WriteError("DirectInput8Create fail");
		return false;
	}
